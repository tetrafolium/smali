...
public class LocatedItemsTest {
    ...
    private List<BuilderDebugItem> createItems(final int count) {
    ...
    private void doTestMergeIntoKeepsOrderOfDebugItems(final int countLocation1, final int countLocation2) {
